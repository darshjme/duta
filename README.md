...
<img src="assets/agent-dispatcher-hero.png" alt="agent-dispatcher — Vedic Arsenal by Darshankumar Joshi" width="100%" />

# 🌊 agent-dispatcher

<h3><em>दूत</em></h3>

> *Duta — the divine messenger*
...
```mermaid
flowchart LR
    A[Input] --> B[agent-dispatcher]
    B --> C{Process}
    C -- Success --> D[Output]
    C -- Error --> E[Handle / Retry]
    E --> B
    style B fill:#6b21a8,color:#fff
    note["Dispatcher — Zero Dependencies"]
```
